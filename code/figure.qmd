...
timing_pretty <- ggdraw() +
  ...
  draw_image('svg/egg.png',         x = 0.08,  y = 0.78, width = 0.15, height = 0.15) +
  draw_image('svg/cleavage.png',    x = 0.205, y = 0.78, width = 0.15, height = 0.15) +
  draw_image('svg/morula.png',      x = 0.33,  y = 0.78, width = 0.15, height = 0.15) +
  draw_image('svg/prawnchip.png',   x = 0.455, y = 0.78, width = 0.15, height = 0.15) +
...
```{r}
timing_pretty <- timing_pretty + theme(aspect.ratio = 1.6)
abnormality <- abnormality + theme(aspect.ratio = 1.6)

combined <- timing_pretty | abnormality +
...
survival / (timing_pretty | abnormality)+
  plot_annotation(
