...
tidy_bros %>% 
  filter(if_any(everything(), is.na))
```
![Sample 3L9 only contained two dissolving debris fragments](../scope-images/3L9/3L9_4xstitch_anno.jpg)
![Sample 7H9 contained many dissolving debris fragments, but none appearing viable](../scope-images/7H9/7H9_manualstitch_anno.jpg)
