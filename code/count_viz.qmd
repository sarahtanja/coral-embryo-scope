...
```{r}
ggplot(tidy_bros, aes(x = stage, fill = status)) +
  geom_bar(alpha = 0.7) +
...
```
```{r}
ggplot(tidy_vials, aes(x = hpf, y = n_embryos, fill = treatment)) +
  ...
  ggtitle("Counts of total viable embryos across treatment and time")+
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))  # Rotate x-axis labels

ggsave("../plots/counts_survival_boxplot.png", width = 8, height = 6, dpi = 300)
```
