...
## Percent composition of status categories per treatment and timepoint
```{r}
...
## Embryo counts for each status category per treatment and timepoint
```{r}
...
patch_pretty <- ggdraw() +
  ...
  draw_image('../svg/egg.png',         x = 0.05,  y = 0.415, width = 0.056, height = 0.056) +
  draw_image('../svg/cleavage.png',    x = 0.11, y = 0.415, width = 0.056, height = 0.0568) +
  draw_image('../svg/morula.png',      x = 0.17,  y = 0.415, width = 0.056, height = 0.056) +
  draw_image('../svg/prawnchip.png',   x = 0.23, y = 0.415, width = 0.056, height = 0.056) +
  draw_image('../svg/earlygastrula.png', x = 0.29,  y = 0.415, width = 0.056, height = 0.056)

patch_pretty
```
## Legend patch
```{r}
B_panel <- timing + stage_legend_plot + plot_layout(widths = c(6, 2))
