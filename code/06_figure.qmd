...
```
```{r}
ggsave("../figs/morphology_boxplot.png", width = 8, height = 6, dpi = 900)
```

# TIMING ONLY

```{r}
T1 <- timing + stage_legend_plot + plot_layout(widths = c(4, 1.1))
T1
```

```{r, fig.height=12}
T2 <- T1 / timing_forest_legendary + plot_layout(heights = c(1, 1))
T2
```
